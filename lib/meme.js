...
const random = async (_subreddit) => new Promise((resolve, reject) => {
    const subreddits = ['humor negro', 'meme español', 'humor verde', 'chistes malos', 'el pepe meme', 'memes en español', 'memes obvios', 'memes made in spain', 'memes de historia', 'humor español', 'humor andaluz']
